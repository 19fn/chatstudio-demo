...
function renderProfile() {
  elements['profile-details'].replaceChildren(...profileDetails(state.account, state.authConfig).flatMap(([label, value]) => {
...
function bindEvents() {
  ...
  elements['profile-toggle'].addEventListener('click', () => {
    renderProfile();
